...
function Home({ texto, funcion, className }) {

    return (
        <>
            <section className="bg-blanco h-[125vh] md:h-[90vh] lg:h-[100vh] font-bold font-Montserrat flex flex-col justify-center lg:flex-row px-4 lg:px-16 ">
                <div className="w-full md:w-3/5 md:h-full p-4 flex flex-col justify-center gap-8">
                    <h1 className="text-primario text-2xl md:text-4xl lg:text-5xl">Tu confiable inventario de oportunidades</h1>
